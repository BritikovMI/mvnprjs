...
<f:view>
    <h:form id="calcForm">
        ...
        <h:messages infoClass="infoClass" errorClass="errorClass" layout="table" globalOnly="true"/>
                ...
                <h4><h:outputText value="#{calculatorController.rateStatus}" /></h4>
        <%--<h:panelGrid columns="3" rowClasses="oddRow, evenRow"--%>
                     <%--styleClass="formGrid">--%>
            <%--&lt;%&ndash; First Number&ndash;%&gt;--%>
        ...
        <%--</h:panelGrid>--%>
        <div>
            <h:commandButton action="#{calculatorController.CourseD}"  value="GetCourse" />
